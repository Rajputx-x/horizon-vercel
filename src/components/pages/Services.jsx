...
const services = [
    { title: "IFTA Reporting", description: "If your vehicle: -is used to transport people or property; -has three or two axles as well as an actual or registered gross vehicles weight that exceeds 26,000 Ibs (11,797 kgs) - or if in combination the actual or registered gross vehicles weight is more than 26,000 Ibs. (11,797 kgs). You must submit the IFTA quarterly fuel report.", img: "/card1.webp" },
    { title: "Trucking Accounting", description: "Horizon Solutions provides trucking accounting services to keep you and your truck on the road. While you are out there on the road, we give all the necessary support and assistance to get the job done the right way, time and time again.", img: "/card2.webp" },
    { title: "Document Management & Paperwork", description: "Horizon Solutions offers an extensive range of solutions for truckers and trucking companies. Including dispatching services dedicated to providing you invaluable support.", img: "/card3.webp" },
    { title: "Freight Factoring", description: "As with any important business decision, whether you decide to use a truck factoring service depends on your business model, scale of operations, and how much risk you want to assume. Horizon Solutions is here to guide you.", img: "/card4.webp" },
    { title: "Freight Rate Negotiation", description: "Horizon Solutions goes far beyond simple average rate negotiation. We help you position your operation and your brand at the forefront of the market. We’ll take care of everything. All you need to do is drive.", img: "/card5.webp" },
    { title: "Dispatching – Trucking Services", description: "Truck Dispatching: Keeping Your Business Moving So You Can Focus on Driving. Here at Horizon Solutions, we are proud to be the truck dispatching company you can rely on.", img: "/card6.webp" },
    { title: "Company Formation", description: "Horizon Solutions can help you create the company, register your trailers and vehicles, and get all the necessary documents and paperwork to get you up and running. We’re happy to support you, whatever stage in the process you are.", img: "/card7.webp" },
    { title: "Truckers Accounting", description: "Driving your truck, achieving great results for the customers you work with, and providing your transportation expertise to long-term clients – these are some of your passions. Trucking accounting is probably lower down in the list of things you enjoy. Let Horizon Solutions handle it for you.", img: "/card.webp" },
    { title: "Trucking Invoice Service", description: "Your trucking services offer great advantages to your clients. They have specific needs related to the transportation and delivery of goods, and you have the skills and equipment required to fulfill those needs. But you need to be supported too – you need the steady stream of revenue that keeps you on the road and your business growing. Horizon Solutions is here to help.", img: "/card9.webp" },
    { title: "Truck Document Management", description: "The successful management of trucking requires striking a balance. While trucking is largely about driving, and your clients love the results you achieve for them in this capacity, there is much more going on behind the scenes. Horizon Solutions ensures everything runs smoothly.", img: "/card10.webp" },
    { title: "Document Dispatch Services", description: "Horizon Solutions understands that hauling products from point A to point B is not the end of the day for truck drivers. Truck drivers are faced with hours of administrative paperwork long after their route is complete. We’re here to simplify that process.", img: "/card11.webp" },
];
